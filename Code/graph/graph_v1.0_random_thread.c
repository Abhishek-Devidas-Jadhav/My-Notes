...
int main(){
    pthread_t input_t,processing_t,output_t;
    if(pthread_create(&input_t,NULL,&input,NULL)!=0)
        exit(0);
    if(pthread_create(&processing_t,NULL,&processing,NULL)!=0)
        exit(0);
    if(pthread_create(&output_t,NULL,&output,NULL)!=0)
        exit(0);
    while(1){
